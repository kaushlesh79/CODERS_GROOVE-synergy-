...
function Home() {
  const [roomId, setRoomId] = useState("");//for storing room id and setting it for the room
  const [username, setUsername] = useState("");//for storing username and setting it for current joine 
